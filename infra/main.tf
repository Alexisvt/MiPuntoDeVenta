...
resource "aws_cloudfront_origin_access_control" "frontend" {
  name                              = local.name
  description                       = "Private S3 origin for the Next.js static application"
...
resource "aws_cloudfront_function" "spa_rewrite" {
  ...
  comment = "Serve route-specific static HTML without masking backend responses"
  publish = true
  code    = file("${path.module}/cloudfront/frontend-rewrite.js")
}
