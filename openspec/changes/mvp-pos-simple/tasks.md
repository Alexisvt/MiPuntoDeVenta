...
|---|---|---|
| 1 | Next.js/Spring foundation and delivery contracts | feature/tracker → `feat/mvp-foundation` |
...
- [x] 1.2 Bootstrap the frontend platform with strict TypeScript, tests, lint and accessibility baseline; superseded by `migrate-frontend-to-nextjs`.
...
- [x] 1.7 RED/GREEN: prove a backend health endpoint and an accessible frontend health view.
...
- [ ] 2.3 Build accessible Next.js user/product flows with empty, error and keyboard states.
